    ...
    return (
        <div className="min-h-screen bg-[#050a14] flex items-center justify-center p-4">
            <div className="text-center text-white max-w-sm">
                ...
                <a href="/admin/login" className="inline-block bg-[#c5a059] text-[#050a14] px-5 py-2.5 rounded-lg font-medium text-sm hover:bg-white transition-colors">Volver al inicio de sesión</a>
            </div>
        </div>
    );
}