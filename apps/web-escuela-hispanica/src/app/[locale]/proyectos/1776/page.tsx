    ...
    const founders = [
        ...
        },
        {
            ...
            description: {
                ...
                pt: 'Jefferson demonstrou um interesse sustentado na cultura e no pensamento hispânico: leu e adquiriu obras de Cervantes, incluindo *Dom Quixote*. Durante a sua estada diplomática na Europa, incluiu obras de Juan de Mariana na sua biblioteca. O seu interesse alcançou também autores como Juan de Palafox y Mendoza, ligando a defesa clássica de uma autoridade submetida à lei moral e ao bem comum aos ideais da revolução.'
            }
        },
        {
            name: 'James Madison',
        ...
        },
        {
            ...
            description: {
                es: 'No *Report on Public Credit* (1790) y el *Report on a National Bank* (1790), Hamilton vincula estabilidad monetaria, confianza pública y libertad política, afirmando que el orden constitucional requiere un sistema financiero capaz de evitar arbitrariedades fiscales. Esta preocupación conecta con la crítica de Juan de Mariana en *De Monetae Mutatione* (1609), donde la manipulación de la moneda se describe como un impuesto encubierto contrario al consentimiento político. Aunque Hamilton adopta soluciones institucionales distintas —la creación de un banco nacional y un crédito público sólido— comparte la premisa escolástica de que la legitimidad del poder depende de respetar la propiedad y evitar formas indirectas de exacción. La arquitectura económica de la joven república traduce así al plano práctico un problema ya formulado en la escolástica hispánica: la relación entre moneda, tributación y soberanía, incorporando a la experiencia constitucional americana debates originados dos siglos antes en la teoría moral y jurídica ibérica.',
                en: 'In the *Report on Public Credit* (1790) and the *Report on a National Bank* (1790), Hamilton links monetary stability, public trust, and political liberty. This concern connects with Juan de Mariana\'s critique in *De Monetae Mutatione* (1609), where currency manipulation is described as a hidden tax contrary to political consent. The economic architecture of the young republic incorporated debates originated two centuries earlier in Iberian moral theory.',
                pt: 'No *Report on Public Credit* (1790) e no *Report on a National Bank* (1790), Hamilton liga estabilidade monetária, confiança pública e liberdade política. Esta preocupação conecta-se com a crítica de Juan de Mariana em *De Monetae Mutatione* (1609), onde a manipulação de moeda é descrita como imposto encoberto.'
            }
        }
    ];
                                    ...
                                    {founders.map((founder) => (
                                        <div key={founder.name} className="group bg-[#050a14] p-8 md:p-12 hover:bg-[#0a111e] transition-all duration-500">
                                            ...
                                            <p className="text-white/50 font-serif text-sm leading-relaxed group-hover:text-white/70 transition-colors whitespace-pre-line">
                                                <RichText text={founder.description[locale as 'es' | 'en' | 'pt']} />
                                            </p>
                                        </div>
                                    ))}
                                </div>
                                    ...
                                    {thinkers.map((item) => (
                                        <div key={item.name} className="space-y-4">
                                            ...
                                            <p className="text-white/50 font-serif text-sm leading-relaxed whitespace-pre-line">
                                                <RichText text={item.description[locale as 'es' | 'en' | 'pt']} />
                                            </p>
                                        </div>
                                    ))}
                                </div>
