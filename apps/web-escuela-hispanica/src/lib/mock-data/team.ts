...
Escreveu e publicou artigos em meios de comunicação de referência como Expansión, Vozpópuli, El Economista, El Confidencial e Libertad Digital em Espanha; El Expreso no Equador e no Peru; bem como em diversas publicações do Panamá, Colômbia e outros países. Da mesma forma, manteve reuniões e relações estreitas com líderes conservadores, especialmente no continente americano - do Canadá à Argentina - e na Europa.`,
    ...
    pt: 'Campo Maior (Portugal), 2001. Licenciado em Ciência Política e Relações Internacionais pela Faculdade de Ciências Sociais e Humanas da Universidade Nova de Lisboa, é atualmente editor da secção internacional do jornal Nascer do SOL, onde publica semanalmente uma coluna e vários artigos jornalísticos, e é Mestre em Economia Internacional e Estudos Europeus pelo ISEG, Universidade de Lisboa. Colabora ocasionalmente na coluna da Oficina da Liberdade publicada no Observador.'
        ...
        },
        {
            ...
            role: { es: 'RESPONSABLE DE COORDINACIÓN', en: 'COORDINATION MANAGER', pt: 'RESPONSÁVEL DE COORDENAÇÃO' },
            country: 'El Salvador',
            image: '/images/team/julianamontoya.jpeg',
            bio: {
                es: 'San Salvador (El Salvador), 2005. Estudiante de Administración y Dirección de Empresas en la Universidad de Navarra. Su perfil está fuertemente orientado a la estrategia empresarial, la consultoría y la innovación, áreas que potencia activamente como miembro del Consulting Club y a través de su participación en competiciones de resolución de casos de negocio, tanto a nivel universitario como internacional. Comprometida con el impacto social, cuenta además con experiencia en proyectos de voluntariado. En Escuela Hispánica es responsable de la coordinación de comunicación, liderando la gestión y difusión de las iniciativas de la organización.',
                en: 'San Salvador (El Salvador), 2005. Student of Business Administration at the University of Navarra. Her profile is strongly oriented towards business strategy, consulting and innovation, areas she actively develops as a member of the Consulting Club and through participation in business case competitions at both university and international level. Committed to social impact, she also has experience in volunteering projects. At Escuela Hispánica she is responsible for communications coordination, leading the management and dissemination of the organisation\'s initiatives.',
                pt: 'San Salvador (El Salvador), 2005. Estudante de Administração e Direção de Empresas na Universidade de Navarra. O seu perfil está fortemente orientado para a estratégia empresarial, a consultoria e a inovação, áreas que desenvolve ativamente como membro do Consulting Club e através da participação em competições de resolução de casos de negócio, tanto a nível universitário como internacional. Comprometida com o impacto social, conta também com experiência em projetos de voluntariado. Na Escuela Hispánica é responsável pela coordenação de comunicação, liderando a gestão e divulgação das iniciativas da organização.'
            },
        },
        {
            name: 'Fernando Egaña Montero',
            role: { es: 'RESPONSABLE DE PROYECTOS Y MIEMBROS ACADÉMICOS', en: 'PROJECTS & ACADEMIC MEMBERS MANAGER', pt: 'RESPONSÁVEL DE PROJETOS E MEMBROS ACADÉMICOS' },
            country: 'España',
            image: '/images/team/fernandoegaña.jpeg',
            bio: {
                es: 'Fernando Egaña Montero es estudiante de Filosofía, Política y Economía (PPE) en la Universidad de Navarra, donde forma parte del Finance Club, el Consulting Club, el Political Thought Club y el Debate Club. Ha sido campeón de oratoria de la Comunidad de Madrid, subcampeón del torneo autonómico de debate y ganador del torneo de debate de la Universidad Carlos III. Su perfil combina interés por las instituciones públicas, la empresa, las finanzas y el pensamiento político, con una marcada vocación de servicio. Ha realizado más de 400 horas de voluntariado nacional e internacional en España, Sudáfrica, Camerún y Perú, asumiendo responsabilidades de liderazgo logístico y operativo en distintos proyectos. En Escuela Hispánica colabora en el desarrollo de iniciativas orientadas a fortalecer los vínculos culturales, educativos e institucionales entre el mundo hispánico, Europa y América. Es responsable de proyectos y miembros académicos.',
                en: 'Fernando Egaña Montero is a student of Philosophy, Politics and Economics (PPE) at the University of Navarra, where he is a member of the Finance Club, the Consulting Club, the Political Thought Club and the Debate Club. He has been oratory champion of the Community of Madrid, runner-up in the regional debate tournament and winner of the Universidad Carlos III debate tournament. His profile combines an interest in public institutions, business, finance and political thought with a strong vocation for service. He has completed more than 400 hours of national and international volunteering in Spain, South Africa, Cameroon and Peru, taking on logistical and operational leadership responsibilities in various projects. At Escuela Hispánica he collaborates in the development of initiatives aimed at strengthening cultural, educational and institutional ties between the Hispanic world, Europe and the Americas. He is responsible for projects and academic members.',
                pt: 'Fernando Egaña Montero é estudante de Filosofia, Política e Economia (PPE) na Universidade de Navarra, onde faz parte do Finance Club, do Consulting Club, do Political Thought Club e do Debate Club. Foi campeão de oratória da Comunidade de Madrid, vice-campeão do torneio autonómico de debate e vencedor do torneio de debate da Universidad Carlos III. O seu perfil combina o interesse pelas instituições públicas, a empresa, as finanças e o pensamento político, com uma marcada vocação de serviço. Realizou mais de 400 horas de voluntariado nacional e internacional em Espanha, África do Sul, Camarões e Peru, assumindo responsabilidades de liderança logística e operativa em diferentes projetos. Na Escuela Hispánica colabora no desenvolvimento de iniciativas orientadas a fortalecer os vínculos culturais, educativos e institucionais entre o mundo hispânico, a Europa e as Américas. É responsável por projetos e membros académicos.'
            },
        },
    ]
};
