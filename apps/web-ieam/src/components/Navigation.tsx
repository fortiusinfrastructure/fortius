      ...
      <div className="page-shell">
        <div className="flex items-center justify-between h-[72px]">
          ...
          <div className="hidden lg:flex lg:items-center lg:space-x-5">
            ...
            <Link
              href="/colabora"
              className="inline-flex items-center px-6 py-2 text-[11px] font-bold uppercase tracking-[0.2em] !text-white hover:!text-white bg-[#0A2540] hover:bg-[#006994] transition-colors shadow-sm rounded-none"
            >
              {t('collaborate')}
            </Link>
          </div>
            ...
            <div className="pt-4 pb-4 border-t hairline">
              <div className="flex items-center px-4 space-x-4">
                ...
                <Link
                  href="/colabora"
                  onClick={() => setIsOpen(false)}
                  className="block w-full text-center px-4 py-2 text-sm font-bold tracking-[0.18em] !text-white hover:!text-white bg-[#0A2540] hover:bg-[#006994]"
                >
                  {t('collaborate')}
                </Link>
              </div>
