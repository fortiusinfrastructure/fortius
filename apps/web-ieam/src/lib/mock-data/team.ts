...
export const researchFellows: TeamMember[] = [
    ...
    {
        img: "/team/Souleymane_Fall.webp",
        name: "Souleymane Fall",
        role: "Investigador asociado",
        role_en: "Associate Researcher",
        linkedin: "#",
        bio: "Dakar (Senegal). Souleymane Fall es un profesional del ámbito humanitario y del desarrollo con experiencia en migración internacional, protección y programación regional en África Occidental y Central. Ha trabajado con la Organización Internacional para las Migraciones (OIM) entre 2021 y 2025, así como con ONG, desempeñando funciones tanto a nivel operativo como regional. Ha contribuido al diseño, seguimiento y análisis de programas relacionados con la migración, incluidos ámbitos como la reintegración, la protección de migrantes y la gobernanza migratoria regional. Ha desarrollado una sólida experiencia en protección, análisis de datos, elaboración de informes y programación basada en evidencias, apoyando la toma de decisiones estratégicas y la coordinación regional. Anteriormente, como Office Manager y Protection Officer en el seno de una organización socia implementadora de ACNUR en el marco del proyecto Route-Based Approach, lideró intervenciones de protección dirigidas a poblaciones vulnerables, incluidas víctimas de trata (VOT), menores no acompañados y personas desplazadas, al tiempo que mantenía una estrecha coordinación con actores humanitarios y autoridades locales. Souleymane cuenta con sólidas competencias en análisis humanitario, gestión de la información y coordinación interinstitucional, así como con un profundo conocimiento de las dinámicas migratorias, los marcos de protección y los procesos de políticas regionales. Es licenciado en Derecho y Ciencias Políticas por la Universidad Cheikh Anta Diop de Dakar.",
        bio_en: "Dakar (Senegal). Souleymane Fall is a humanitarian and development professional with experience in international migration, protection, and regional programming in West and Central Africa. He worked with the International Organization for Migration (IOM) between 2021 and 2025, as well as with NGOs, carrying out functions at both operational and regional levels. He has contributed to the design, monitoring, and analysis of migration-related programmes, covering areas such as reintegration, migrant protection, and regional migration governance. He has developed strong expertise in protection, data analysis, reporting, and evidence-based programming, supporting strategic decision-making and regional coordination. Previously, as Office Manager and Protection Officer within a UNHCR implementing partner organization under the Route-Based Approach project, he led protection interventions targeting vulnerable populations, including victims of trafficking (VOT), unaccompanied minors, and displaced persons, while maintaining close coordination with humanitarian actors and local authorities. Souleymane has strong competencies in humanitarian analysis, information management, and inter-agency coordination, as well as an in-depth knowledge of migration dynamics, protection frameworks, and regional policy processes. He holds a degree in Law and Political Science from Cheikh Anta Diop University in Dakar."
    },
    {
        img: "/team/Fodi_Tandjigora.webp",
        name: "Fodié Tandjigora",
        role: "Investigador asociado",
        role_en: "Associate Researcher",
        linkedin: "#",
        bio: "Bamako (Malí). Fodié Tandjigora es doctor en sociología de las migraciones y de las relaciones interétnicas por la Universidad Paris-Sorbonne-Cité y profesor titular en la Universidad Yambo Oulogueme de Bamako. Fue jefe del departamento de Sociología y Antropología de la Universidad de Letras y Ciencias Humanas de Bamako (ULSHB) entre 2019 y 2023, y también ocupó el cargo de director adjunto del máster en Migración y Desarrollo entre 2013 y 2015. Investigador asociado al laboratorio URMIS (Unidad de Investigación Migraciones y Sociedades) de la Universidad Paris 7 Diderot y miembro del comité científico del Centro de Información y Gestión sobre las Migraciones (CIGEM), cuenta con más de dieciséis años de experiencia en la docencia y la investigación. Sus trabajos se centran en las rutas migratorias clandestinas desde el África subsahariana hacia Europa a través del Magreb, así como en los mecanismos de dependencia de los ingresos de la migración en las comunidades de origen.",
        bio_en: "Bamako (Mali). Fodié Tandjigora holds a PhD in sociology of migration and interethnic relations from Paris-Sorbonne-Cité University and is an associate professor at Yambo Oulogueme University in Bamako. He served as head of the Department of Sociology and Anthropology at the University of Letters and Human Sciences of Bamako (ULSHB) from 2019 to 2023, and previously held the position of deputy director of the Master's programme in Migration and Development between 2013 and 2015. An associate researcher at the URMIS laboratory (Research Unit on Migrations and Societies) at Paris 7 Diderot University and a member of the scientific committee of the Centre for Information and Management on Migration (CIGEM), he has over sixteen years of experience in teaching and research. His work focuses on clandestine migration routes from sub-Saharan Africa to Europe through the Maghreb, as well as the mechanisms of income dependency on migration in communities of origin."
    }
];
