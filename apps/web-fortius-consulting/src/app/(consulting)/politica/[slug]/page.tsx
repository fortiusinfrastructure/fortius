            ...
            <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                    ...
                    <h2 className="mt-4 font-display text-[1.6rem] md:text-[2rem] font-light leading-[1.15] text-[var(--text-primary)]">
                        El análisis completo está reservado a miembros de Fortius.
                    </h2>
                    <p className="mt-4 text-[var(--text-secondary)] leading-relaxed">
                        Las notas de inteligencia política incluyen escenarios, riesgos y
                        recomendaciones operativas — además de los subproductos vinculados.
                        Suscríbete para acceder al texto íntegro y a la biblioteca completa.
                    </p>
                    <div className="mt-6 flex flex-wrap gap-3">
                        <Link
                            href="/politica#membresias"
