...
export const ALLIES: Ally[] = [
    ...
    { name: "Acton", logo: "/images/aliados/Acton.png", filter: "brightness(0) invert(1)" },
    ...
    { name: "THC", logo: "/images/aliados/THC.png" },
    { name: "Danube Institute", logo: "/images/aliados/Danue Institute.png" },
