...
export const FOUNDATION_QUOTES_EN = [
  "We serve those who have chosen to serve.",
  "We work with those who understand leadership as service, not as privilege.",
  "We do not accompany those who build a career from a cause. We accompany those who accept the duty to defend it.",
  "The best causes deserve the best strategists.",
];
...
export const ABOUT_SECTIONS = [
  {
    ...
    kicker_en: "Who we are",
    title: "Impulsamos a quienes entienden el liderazgo como servicio.",
    title_en: "We empower those who understand leadership as service.",
    body: [
    ...
    body_en: [
      "Fortius Foundation strengthens people, organisations and initiatives that want to serve with seriousness, rigour and a vocation for legacy.",
      "We believe that great causes need strong institutions, well-prepared teams and a structure capable of sustaining them over time.",
    ],
  },
  {
    kicker: "Nuestra filosofía",
    kicker_en: "Our philosophy",
    title: "Trabajamos para que las ideas correctas transformen la sociedad.",
    title_en: "We work so that the right ideas transform society.",
    body: [
    ...
    body_en: [
      "Ideas only change history when they find people and institutions capable of embodying, defending and projecting them with excellence.",
      "That is why we work where training, structure, community and long-term vision are needed.",
    ],
  },
  {
    kicker: "A quién servimos",
    kicker_en: "Whom we serve",
    title: "Trabajamos con quienes aspiran a construir legado.",
    title_en: "We work with those who aspire to build a legacy.",
    body: [
    ...
    body_en: [
      "We support foundations, think tanks, educational initiatives, emerging leaders, social entrepreneurs and civic actors committed to cultural and institutional renewal.",
      "We work with those who want to build a legacy, not just a presence.",
    ],
  },
  {
    ...
    title_en: "Much more than passive support.",
    body: [
    ...
    body_en: [
      "We do not limit ourselves to funding. We act as a platform for coordination, drive and strategic support.",
      "We connect talent, resources, ideas and opportunities so that serious projects gain consistency, scale and impact.",
    ],
  },
];

export const FOUNDATION_TIMELINE = [
  { year: "2023", label: "Nace Fundación Fortius España", label_en: "Fortius Foundation Spain established", place: "Madrid" },
  { year: "2025", label: "Nace Fortius Foundation United States", label_en: "Fortius Foundation United States established", place: "Houston, Texas" },
];
...
export const FOUNDATION_TIMELINE_COPY_EN = [
  "We have spent years supporting organisations and institutions across Europe, the Americas and Africa.",
  "This journey has allowed us to build a network of allies, projects and institutional leaders with whom we share rigour, discernment and a vocation for service.",
];
...
export const STRATEGIC_PARTNERS = [
  {
    ...
    copy_en: "TrustBridge is a Switzerland-based hub for a global platform of philanthropic payments and impact investment. As part of this network, Fortius Foundation Spain enables donors in Spain to make international donations with full confidence and the corresponding tax-deductibility certificates.",
  },
  {
    name: "Together.eu",
    ...
    copy_en: "Together.eu, an initiative of the European Parliament, is a pan-European civic participation platform aimed at strengthening democracy and civil society engagement in European public life. This collaboration reinforces our vocation to contribute to a more informed, free and committed citizenry for the future of Europe.",
  },
];
