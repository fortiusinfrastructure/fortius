...
export function PersonPortrait({
    ...
    return (
        <div
            ...
            style={{
                background:
                    "radial-gradient(ellipse at 30% 25%, rgba(255,255,255,0.10) 0%, transparent 55%), linear-gradient(145deg, rgba(20,30,25,0.95) 0%, rgba(6,12,9,1) 100%)",
            }}
        ...
        >
            {photo ? (
                ...
                <img
                    ...
                    style={{ filter: "grayscale(1) contrast(1.05) sepia(0.15) hue-rotate(80deg)" }}
                />
            ) : (
                <>
                    <div
