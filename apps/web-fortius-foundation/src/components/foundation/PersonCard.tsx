...
export function PersonCard({
    ...
    return (
        ...
        >
            ...
            <span
                className="shrink-0 inline-flex items-center justify-center w-7 h-7 border border-[var(--border-default)] text-[var(--text-tertiary)] group-hover:text-[var(--color-accent-300)] group-hover:border-[var(--color-accent-400)] transition-colors"
                aria-hidden
            >
                <Plus size={14} />
            </span>
